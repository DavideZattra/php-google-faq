...
<body>
    ...
    <main>
        ...
        foreach ($faq as $quest) {
            echo "<h1>" . $quest["question"] . "</h1>";
            // echo "<p>" . $quest["answers"] . "</p>"; //MODE 1
            foreach ($quest["answers"] as $answer){
                echo "<p>" . $answer . "</p>";      //MODE 2
            };
        };
        ?>
    </main>
